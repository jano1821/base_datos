...
CREATE TABLE `detalle_compra` (
  `correlativoDetalle` int(11) NOT NULL,
...
CREATE TABLE `horario` (
  ...
  `horaDescanso` varchar(50) DEFAULT NULL,
  `horaRetorno` varchar(50) DEFAULT NULL,
  `estadoRegistro` varchar(1) NOT NULL,
  `usuarioInsercion` varchar(30) NOT NULL,
  `fechaInsercion` datetime NOT NULL,
  `usuarioModificacion` varchar(30) DEFAULT NULL,
  `fechaModificacion` datetime DEFAULT NULL,
  `codPersona` int(11) NOT NULL,
  `horaIngresoSabatino` varchar(50) DEFAULT NULL,
  `horaSalidaSabatino` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `menu` (
  ...
  `idBoton` varchar(100) DEFAULT NULL,
  `nombreBoton` varchar(100) DEFAULT NULL,
...
CREATE TABLE `producto_unidad` (
  ...
  `codUnidadPadre` int(11) NOT NULL,
  `codUnidadHijo` int(11) NOT NULL,
  `codProducto` int(11) NOT NULL,
  `indicadorPrincipal` varchar(1) NOT NULL,
  `contenido` decimal(13,3) DEFAULT NULL,
  `estadoRegistro` varchar(1) DEFAULT NULL,
  `usuarioInsercion` varchar(30) NOT NULL,
  `fechaInsercion` datetime NOT NULL,
  `usuarioModificacion` varchar(30) DEFAULT NULL,
...
CREATE TABLE `registro_asistencia` (
  ...
  `codTipoAsistencia` int(11) NOT NULL,
  `codPersona` int(11) NOT NULL,
  ...
  `usuarioModificacion` varchar(30) DEFAULT NULL,
  `fechaModificacion` datetime DEFAULT NULL,
  `minTardanza` int(11) DEFAULT NULL,
...
CREATE TABLE `sistema` (
  ...
  `urlIcono` varchar(500) DEFAULT NULL,
  `indicadorAdministrador` varchar(1) DEFAULT NULL,
  `estadoRegistro` varchar(1) NOT NULL,
  `usuarioInsercion` varchar(30) NOT NULL,
  `fechaInsercion` datetime NOT NULL,
  `usuarioModificacion` varchar(30) DEFAULT NULL,
...
ALTER TABLE `direccion`
  ...
  ADD KEY `R_9` (`codDistrito`),
  ADD KEY `R_13` (`codPersona`);
...
ALTER TABLE `historico_movimientos`
  ...
  ADD KEY `R_42` (`codUbicacion`),
  ADD KEY `R_43` (`codAlmacen`),
  ADD KEY `R_44` (`codProducto`),
  ADD KEY `R_46` (`codPersona`),
  ADD KEY `R_49` (`codUnidad`);
...
ALTER TABLE `logistica`
  ...
  ADD KEY `R_47` (`codProducto`),
  ADD KEY `R_48` (`codUnidad`),
  ADD KEY `R_53` (`codAlmacen`);
...
ALTER TABLE `menu_sistema`
  ...
  ADD KEY `R_81` (`codSistema`),
  ADD KEY `R_82` (`codUsuario`);
...
ALTER TABLE `producto`
  ...
  ADD KEY `R_39` (`codCategoria`),
  ADD KEY `R_40` (`codMarca`),
  ADD KEY `R_41` (`codModelo`);
...
ALTER TABLE `producto_unidad`
  ...
  ADD KEY `R_31` (`codUnidadPadre`),
  ADD KEY `R_32` (`codUnidadHijo`),
  ADD KEY `R_33` (`codProducto`);
...
ALTER TABLE `registro_asistencia`
  ...
  ADD KEY `R_62` (`codTipoAsistencia`),
  ADD KEY `R_63` (`codPersona`);
...
ALTER TABLE `telefono`
  ...
  ADD KEY `R_10` (`codOperador`),
  ADD KEY `R_11` (`codPersona`);
...
ALTER TABLE `ubicacion`
  ...
  ADD KEY `R_34` (`codSecion`),
  ADD KEY `R_35` (`codZona`),
  ADD KEY `R_36` (`codSector`),
  ADD KEY `R_38` (`codAlmacen`),
  ADD KEY `R_57` (`codProducto`);
...
--
ALTER TABLE `comprobante`
  MODIFY `codComprobante` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `detalle_compra`
  MODIFY `correlativoDetalle` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `logistica`
  MODIFY `codLogistica` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `menu`
  MODIFY `codMenu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `operador`
  MODIFY `codOperador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
...
--
ALTER TABLE `registro_asistencia`
  MODIFY `codRegistroAsistencia` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `seccion`
--
ALTER TABLE `seccion`
  MODIFY `codSecion` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `sector`
--
ALTER TABLE `sector`
  MODIFY `codSector` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tipo_asistencia`
  MODIFY `codTipoAsistencia` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tipo_pago`
  MODIFY `codTipoPago` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `zona`
  MODIFY `codZona` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `agencia`
  ADD CONSTRAINT `R_58` FOREIGN KEY (`codEmpresa`) REFERENCES `empresa` (`codEmpresa`);

--
-- Filtros para la tabla `cliente`
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `R_15` FOREIGN KEY (`codPersona`) REFERENCES `persona` (`codPersona`);

--
-- Filtros para la tabla `compra`
--
ALTER TABLE `compra`
  ADD CONSTRAINT `R_59` FOREIGN KEY (`codComprobante`) REFERENCES `comprobante` (`codComprobante`);

--
-- Filtros para la tabla `correlativo_comprobante`
--
ALTER TABLE `correlativo_comprobante`
  ADD CONSTRAINT `R_69` FOREIGN KEY (`codVenta`) REFERENCES `venta` (`codVenta`),
  ADD CONSTRAINT `R_70` FOREIGN KEY (`codComprobante`) REFERENCES `comprobante` (`codComprobante`);

--
-- Filtros para la tabla `detalle_compra`
--
ALTER TABLE `detalle_compra`
  ADD CONSTRAINT `R_60` FOREIGN KEY (`codCompra`) REFERENCES `compra` (`codCompra`);

--
-- Filtros para la tabla `detalle_venta`
--
ALTER TABLE `detalle_venta`
  ADD CONSTRAINT `R_24` FOREIGN KEY (`codVenta`) REFERENCES `venta` (`codVenta`);

--
-- Filtros para la tabla `direccion`
--
ALTER TABLE `direccion`
  ADD CONSTRAINT `R_13` FOREIGN KEY (`codPersona`) REFERENCES `persona` (`codPersona`),
  ADD CONSTRAINT `R_9` FOREIGN KEY (`codDistrito`) REFERENCES `distrito` (`codDistrito`);

--
-- Filtros para la tabla `distrito`
--
ALTER TABLE `distrito`
  ADD CONSTRAINT `R_8` FOREIGN KEY (`codProvincia`) REFERENCES `provincia` (`codProvincia`);
...
--
ALTER TABLE `empresa_sistema`
  ADD CONSTRAINT `R_1` FOREIGN KEY (`codEmpresa`) REFERENCES `empresa` (`codEmpresa`),
  ADD CONSTRAINT `R_3` FOREIGN KEY (`codSistema`) REFERENCES `sistema` (`codSistema`);

--
-- Filtros para la tabla `historico_movimientos`
--
ALTER TABLE `historico_movimientos`
  ADD CONSTRAINT `R_42` FOREIGN KEY (`codUbicacion`) REFERENCES `ubicacion` (`codUbicacion`),
  ADD CONSTRAINT `R_43` FOREIGN KEY (`codAlmacen`) REFERENCES `almacen` (`codAlmacen`),
  ADD CONSTRAINT `R_44` FOREIGN KEY (`codProducto`) REFERENCES `producto` (`codProducto`),
  ADD CONSTRAINT `R_46` FOREIGN KEY (`codPersona`) REFERENCES `proveedor` (`codPersona`),
  ADD CONSTRAINT `R_49` FOREIGN KEY (`codUnidad`) REFERENCES `unidad_medida` (`codUnidad`);

--
-- Filtros para la tabla `horario`
--
ALTER TABLE `horario`
  ADD CONSTRAINT `R_61` FOREIGN KEY (`codPersona`) REFERENCES `empleado` (`codPersona`);

--
-- Filtros para la tabla `logistica`
--
ALTER TABLE `logistica`
  ADD CONSTRAINT `R_47` FOREIGN KEY (`codProducto`) REFERENCES `producto` (`codProducto`),
  ADD CONSTRAINT `R_48` FOREIGN KEY (`codUnidad`) REFERENCES `unidad_medida` (`codUnidad`),
  ADD CONSTRAINT `R_53` FOREIGN KEY (`codAlmacen`) REFERENCES `almacen` (`codAlmacen`);

--
-- Filtros para la tabla `menu_sistema`
--
ALTER TABLE `menu_sistema`
  ADD CONSTRAINT `R_79` FOREIGN KEY (`codMenu`) REFERENCES `menu` (`codMenu`),
  ADD CONSTRAINT `R_81` FOREIGN KEY (`codSistema`) REFERENCES `sistema` (`codSistema`),
  ADD CONSTRAINT `R_82` FOREIGN KEY (`codUsuario`) REFERENCES `usuario` (`codUsuario`);

--
-- Filtros para la tabla `menu_usuario`
--
ALTER TABLE `menu_usuario`
  ADD CONSTRAINT `R_72` FOREIGN KEY (`codMenu`) REFERENCES `menu` (`codMenu`),
  ADD CONSTRAINT `R_74` FOREIGN KEY (`codUsuario`) REFERENCES `usuario` (`codUsuario`);

--
-- Filtros para la tabla `permisos`
--
ALTER TABLE `permisos`
  ADD CONSTRAINT `R_64` FOREIGN KEY (`codPersona`) REFERENCES `empleado` (`codPersona`);

--
-- Filtros para la tabla `persona`
--
ALTER TABLE `persona`
  ADD CONSTRAINT `R_12` FOREIGN KEY (`codTipoDocumento`) REFERENCES `tipo_documento` (`codTipoDocumento`);

--
-- Filtros para la tabla `producto`
--
ALTER TABLE `producto`
  ADD CONSTRAINT `R_39` FOREIGN KEY (`codCategoria`) REFERENCES `categoria` (`codCategoria`),
  ADD CONSTRAINT `R_40` FOREIGN KEY (`codMarca`) REFERENCES `marca` (`codMarca`),
  ADD CONSTRAINT `R_41` FOREIGN KEY (`codModelo`) REFERENCES `modelo` (`codModelo`);

--
-- Filtros para la tabla `producto_precio`
--
ALTER TABLE `producto_precio`
  ADD CONSTRAINT `R_54` FOREIGN KEY (`codProducto`) REFERENCES `producto` (`codProducto`),
  ADD CONSTRAINT `R_56` FOREIGN KEY (`codPrecio`) REFERENCES `precio` (`codPrecio`);

--
-- Filtros para la tabla `producto_proveedor`
--
ALTER TABLE `producto_proveedor`
  ADD CONSTRAINT `R_25` FOREIGN KEY (`codProducto`) REFERENCES `producto` (`codProducto`),
  ADD CONSTRAINT `R_27` FOREIGN KEY (`codPersona`) REFERENCES `proveedor` (`codPersona`);

--
-- Filtros para la tabla `producto_unidad`
--
ALTER TABLE `producto_unidad`
  ADD CONSTRAINT `R_31` FOREIGN KEY (`codUnidadPadre`) REFERENCES `unidad_medida` (`codUnidad`),
  ADD CONSTRAINT `R_32` FOREIGN KEY (`codUnidadHijo`) REFERENCES `unidad_medida` (`codUnidad`),
  ADD CONSTRAINT `R_33` FOREIGN KEY (`codProducto`) REFERENCES `producto` (`codProducto`);

--
-- Filtros para la tabla `proveedor`
--
ALTER TABLE `proveedor`
  ADD CONSTRAINT `R_14` FOREIGN KEY (`codPersona`) REFERENCES `persona` (`codPersona`);

--
-- Filtros para la tabla `provincia`
--
ALTER TABLE `provincia`
  ADD CONSTRAINT `R_7` FOREIGN KEY (`codDepartamento`) REFERENCES `departamento` (`codDepartamento`);

--
-- Filtros para la tabla `registro_asistencia`
--
ALTER TABLE `registro_asistencia`
  ADD CONSTRAINT `R_62` FOREIGN KEY (`codTipoAsistencia`) REFERENCES `tipo_asistencia` (`codTipoAsistencia`),
  ADD CONSTRAINT `R_63` FOREIGN KEY (`codPersona`) REFERENCES `empleado` (`codPersona`);

--
-- Filtros para la tabla `telefono`
--
ALTER TABLE `telefono`
  ADD CONSTRAINT `R_10` FOREIGN KEY (`codOperador`) REFERENCES `operador` (`codOperador`),
  ADD CONSTRAINT `R_11` FOREIGN KEY (`codPersona`) REFERENCES `persona` (`codPersona`);

--
-- Filtros para la tabla `ubicacion`
--
ALTER TABLE `ubicacion`
  ADD CONSTRAINT `R_34` FOREIGN KEY (`codSecion`) REFERENCES `seccion` (`codSecion`),
  ADD CONSTRAINT `R_35` FOREIGN KEY (`codZona`) REFERENCES `zona` (`codZona`),
  ADD CONSTRAINT `R_36` FOREIGN KEY (`codSector`) REFERENCES `sector` (`codSector`),
  ADD CONSTRAINT `R_38` FOREIGN KEY (`codAlmacen`) REFERENCES `almacen` (`codAlmacen`),
  ADD CONSTRAINT `R_57` FOREIGN KEY (`codProducto`) REFERENCES `producto` (`codProducto`);

--
-- Filtros para la tabla `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `R_17` FOREIGN KEY (`codPersona`) REFERENCES `empleado` (`codPersona`);
